...
import { messageWaning } from "../utils/notifi";
    ...
    <div className="paymentPage">
      ...
      <div className={"container-payment"}>
        {openPayment ? (
          ...
          <div>
            <p className="attention">
              Hãy chắc chắn rằng thông tin của bạn khớp với thông tin trên CCCD,
              CMDN, bằng lái xe hay hộ chiếu do chính chủ cấp!
            </p>
            <div className="choices">
              {/* Vnpay choice */}
              <div className="choice-payment">
        ...
        <div className="confirmation">
          ...
          <form className={"form-per-infor-cf"}>
            <div className={"info-form-couple-cf"}>
              <div className={"label-form-infor-cf"}>
                Tên khách hàng:
              ...
              <div className="row">
                <div className={"label-form-infor-cf"}>
                  Giới tính:{bookingData.customerGender}
                </div>
          ...
          <div className="pay-btn-cf">
            {openPayment ? (
              <button
                onClick={() => navigate(`/booking/${data.servicePackage}`)}
                className={"form-submit-per-infor-cf"}
              >
                quay lại
              </button>
            ) : (
              <button onClick={onFinish} className={"form-submit-per-infor-cf"}>
                Tiếp tục
              </button>
            )}
          </div>
        ...
        <div>
          {data.servicePackageData && (
            <div className={"container-cf"}>
              <div>
                {data.servicePackageData &&
                  data.servicePackageData.image.map(
                    (imageUrl: string, index: number) => (
                      <img
                        className={"image-service-paka-cf"}
                        key={index}
                        src={imageUrl}
              ...
              <div className={"infor-contact-cf"}>
                <p className={"service-package-title"}>
                  {data.servicePackageData.title}
                </p>
                <p className={"service-package-price"}>
                  {groupByComma(data.servicePackageData.price)}vnđ
                </p>
                <p className={"service-package-description"}>
                  {data.servicePackageData.description}
                </p>
                <p className={"service-package-star"}>
                  Số sao: {data.servicePackageData.star.length}
                </p>
                <p className={"service-package-user"}>
                  Người dùng: {data.servicePackageData.user.username}
                </p>
                <p className={"service-package-createAt"}>
                  Đã đăng vào lúc:{" "}
                  {new Date(data.servicePackageData.createAt).toLocaleString()}
                </p>
              </div>
            </div>
          )}
