      ...
      <div>
        ...
        <div className={"container-payment"}>
          <div className="choices">
            ...
            <div className={`choice-momo ${showMomo ? "show" : ""}`}>
              <img className={"momo-frame"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnV4cUM7jBauINof35Yn_unOz976Iz5okV8A&usqp=CAU" alt="MoMo logo" />
            </div>
          </div>
