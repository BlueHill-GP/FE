      ...
      <div className={"container-register"}>
        <>
          {!showOtpInput ? (
              ...
              <div className={"label-form-register-login"}> Tên đầy đủ:
              <Form.Item
                  name="username"
              ...
              <div className={"label-form-register-login"}>Số điện thoại
              <Form.Item
                  name="phone"
          ...
          <div>
            ...
            >
              <div>
                <div className={"OTP-code"}> Nhập mã OTP
              <Form.Item

                  name="OTP"
                  rules={[{ required: true, message: 'Vui lòng nhập mã OTP đã gửi về tài khoản email đăng ký của bạn' }]}
              >
                <Input.Password
                    className={"test-otp"}
                    name="otp"
